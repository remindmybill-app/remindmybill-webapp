    ...
    return (
        <div className="flex min-h-screen flex-col bg-background text-foreground font-sans selection:bg-emerald-500/20 overflow-x-hidden">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-start text-left">
                            ...
                            <motion.p
                                variants={itemVariants}
                                className="text-xl leading-relaxed text-muted-foreground max-w-xl mb-10"
                            >
                                I built Remind My Bill because I was tired of losing money to "free" trials.
                                Our AI finds the leaks, so your inbox finally <span className="text-foreground font-bold underline decoration-emerald-500 underline-offset-4 cursor-help">pays for itself.</span>
                            </motion.p>
                            ...
                            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row items-center gap-6 mb-12 w-full sm:w-auto">
                                ...
                                <Link href="#features" className="text-sm font-bold uppercase tracking-widest text-muted-foreground hover:text-foreground transition-colors">
                                    How it works
                                </Link>
                            </motion.div>
            ...
            <section id="features" className="py-24 sm:py-40 relative">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center mb-24">
                        ...
                        <p className="text-xl text-muted-foreground">Everything you need to stop the bleeding and take back control.</p>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[300px]">
                        <div className="md:col-span-2 row-span-2 rounded-[2rem] bg-card border border-border dark:bg-white/[0.03] dark:border-white/5 p-10 flex flex-col justify-between overflow-hidden relative group hover:border-emerald-500/20 transition-all duration-500">
                            ...
                            <div className="mt-12 rounded-2xl bg-zinc-100 dark:bg-black/40 w-full h-80 border border-border dark:border-white/5 relative overflow-hidden flex items-center justify-center">
                                <div className="absolute inset-0 bg-gradient-to-t from-background dark:from-[#020804] to-transparent z-10"></div>
                                <Inbox className="h-40 w-40 text-muted-foreground/10" />
                                <div className="absolute bottom-10 left-10 right-10 z-20 space-y-3">
                                    <div className="flex items-center gap-4 bg-background/90 dark:bg-white/5 backdrop-blur-2xl p-4 rounded-xl border border-border dark:border-white/10 shadow-2xl">
                                        <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                                        <span className="font-bold text-sm tracking-tight text-foreground">Netflix Subscription Found</span>
                                        <span className="ml-auto text-xs font-medium text-muted-foreground">$15.99/mo</span>
                                    </div>
                                    <div className="flex items-center gap-4 bg-background/90 dark:bg-white/5 backdrop-blur-2xl p-4 rounded-xl border border-border dark:border-white/10 shadow-2xl opacity-60 hover:opacity-100 transition-opacity">
                                        <div className="h-2 w-2 rounded-full bg-yellow-500" />
                                        <span className="font-bold text-sm tracking-tight text-foreground">Adobe Free Trial Ending</span>
                                        <span className="ml-auto text-xs font-medium text-muted-foreground">2 days left</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* Feature 2 */}
                        <div className="md:col-span-1 rounded-[2rem] bg-card border border-border dark:bg-white/[0.03] dark:border-white/5 p-10 flex flex-col relative overflow-hidden group hover:border-orange-500/20 transition-all duration-500">
                            ...
                            <div className="mt-auto pt-6 flex justify-center">
                                <div className="relative h-28 w-28 flex items-center justify-center">
                                    <div className="absolute inset-0 rounded-full border-2 border-border dark:border-white/5"></div>
                        ...
                        {/* Feature 3 */}
                        <div className="md:col-span-1 rounded-[2rem] bg-card border border-border dark:bg-white/[0.03] dark:border-white/5 p-10 flex flex-col relative overflow-hidden group hover:border-blue-500/20 transition-all duration-500">
                            ...
                            <div className="mt-8 space-y-3">
                                <div className="flex items-center justify-between text-xs font-bold p-3 rounded-xl bg-muted/50 border border-border dark:bg-white/5 dark:border-white/5">
                                    <span className="text-muted-foreground uppercase tracking-widest">Trial End</span>
                                    <span className="text-blue-500">3 DAYS</span>
                                </div>
                                <div className="flex items-center justify-between text-xs font-bold p-3 rounded-xl bg-muted/50 border border-border dark:bg-white/5 dark:border-white/5">
                                    <span className="text-muted-foreground uppercase tracking-widest">Renewing</span>
            ...
            <section className="py-24 sm:py-40">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-5xl rounded-[3rem] bg-gradient-to-br from-emerald-500/10 via-border to-transparent p-[1px]">
                        <div className="rounded-[2.95rem] bg-card/90 dark:bg-[#020804]/90 backdrop-blur-3xl p-12 sm:p-24 text-center">
                            ...
                            <p className="text-xl leading-relaxed text-muted-foreground max-w-2xl mx-auto mb-12">
                                We use official Google OAuth verification requesting only <strong className="text-foreground">read-only</strong> access.
