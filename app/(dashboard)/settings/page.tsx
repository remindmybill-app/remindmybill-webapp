              ...
              <div className="rounded-2xl border border-[#1f1f1f] bg-[#111] p-6">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#666] mt-0.5">{authUserEmail}</p>
                  </div>
                  <span className="ml-auto text-xs bg-[#0d2b0d] text-[#22c55e] border border-[#1a4a1a] px-2.5 py-1 rounded-full">Active</span>
                </div>
                <p className="text-xs text-[#555] mt-4 pt-4 border-t border-[#1f1f1f]">
