...
import { Tv, Music, Code, Dumbbell, Cloud, Mail, Package, Gamepad2, Inbox, Sparkles, TrendingUp, Calendar, ArrowUpRight } from "lucide-react"
...
// Add Zap import indirectly since it might be missing from previous list
                ...
                return (
                  <div key={sub.id} className="rounded-2xl border border-zinc-100 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                    <div className="mb-4 flex items-center justify-between">
                      ...
                      <div className={`text-sm font-black tracking-tighter ${getScoreColorClass(sub.trust_score)}`}>
                        {sub.trust_score}%
                      </div>
                    </div>
